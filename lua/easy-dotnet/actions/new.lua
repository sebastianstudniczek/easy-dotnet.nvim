...
M.create_new_item = function(path, cb)
  ...
  local template = require("easy-dotnet.picker").pick_sync(nil, {
    { value = "buildprops", display = "MSBuild Directory.Build.props File", type = "MSBuild/props", file_name = "Directory.Build.props" },
    { value = "packagesprops", display = "MSBuild Directory.Packages.props File", type = "MSBuild/props", file_name = "Directory.Packages.props" },
    { value = "buildtargets", display = "MSBuild Directory.Build.targets File", type = "MSBuild/props", file_name = "Directory.Build.targets" },
    ...
    { value = "tool-manifest", display = "Dotnet Local Tool Manifest File", type = "Config", file_name = "dotnet-tools.json" },
    { value = "editorconfig", display = "EditorConfig File", type = "Config", file_name = ".editorconfig" },
    { value = "globaljson", display = "Global.json File", type = "Config", file_name = "global.json" },
    { value = "nugetconfig", display = "NuGet Config", type = "Config", file_name = "nuget.config" },
    { value = "webconfig", display = "Web Config", type = "Config", file_name = "web.config" },
  ...
  local file_name = ""
  if template.file_name ~= nil then
